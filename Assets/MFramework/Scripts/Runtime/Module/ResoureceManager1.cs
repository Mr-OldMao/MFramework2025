...
//        /// 通用异步资源加载方法
//        /// </summary>
//        public async Task<T> LoadAsync<T>(string path, ResourceSource source = ResourceSource.Resources, Action<LoadProgress> onProgress = null) where T : UnityEngine.Object
//        {
...
//        /// 从AssetBundle异步加载资源
//        /// </summary>
//        public async Task<T> LoadFromAssetBundleAsync<T>(string bundlePath, string assetPath, Action<LoadProgress> onProgress = null) where T : UnityEngine.Object
//        {
//            var progress = new LoadProgress
//            {
...
//                    LastAccessTime = DateTime.Now,
//                    Path = cacheKey,
//                    Source = ResourceSource.AssetBundle,
...
//        /// 异步加载AssetBundle
//        /// </summary>
//        public async Task<AssetBundle> LoadAssetBundleAsync(string bundlePath, bool fromStreamingAssets = true, Action<LoadProgress> onProgress = null)
//        {
...
//        /// 同步实例化游戏对象
//        /// </summary>
//        public GameObject InstantiateSync(string path, Transform parent = null)
//        {
//            var prefab = Resources.Load<GameObject>(path);
//            if (prefab == null)
//            {
//                Debugger.LogError($"同步实例化失败，预制体加载失败: {path}", LogType.FrameCore);
//                return null;
//            }
