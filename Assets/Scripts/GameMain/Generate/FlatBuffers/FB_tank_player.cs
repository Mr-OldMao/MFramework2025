...
public struct FB_tank_player : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_25_2_10(); }
  public static FB_tank_player GetRootAsFB_tank_player(ByteBuffer _bb) { return GetRootAsFB_tank_player(_bb, new FB_tank_player()); }
  public static FB_tank_player GetRootAsFB_tank_player(ByteBuffer _bb, FB_tank_player obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public FB_tank_player __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<GameMain.Generate.FlatBuffers.FB_tank_player> CreateFB_tank_player(FlatBufferBuilder builder,
      int ID = 0,
      int BulletID = 0,
    ...
    FB_tank_player.AddResName(builder, ResNameOffset);
    FB_tank_player.AddHP(builder, HP);
    FB_tank_player.AddMoveSpeed(builder, MoveSpeed);
    FB_tank_player.AddBulletID(builder, BulletID);
    FB_tank_player.AddID(builder, ID);
    return FB_tank_player.EndFB_tank_player(builder);
  }

  public static void StartFB_tank_player(FlatBufferBuilder builder) { builder.StartTable(5); }
  ...
  public static Offset<GameMain.Generate.FlatBuffers.FB_tank_player> EndFB_tank_player(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<GameMain.Generate.FlatBuffers.FB_tank_player>(o);
  }
}


static public class FB_tank_playerVerify
{
